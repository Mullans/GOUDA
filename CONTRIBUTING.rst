...
Welcome to ``GOUDA`` contributor's guide.
...
If you experience bugs or general issues with ``GOUDA``, please have a look
...
You can help improve ``GOUDA`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``GOUDA`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``GOUDA``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n GOUDA python=3 six virtualenv pytest pytest-cov
    conda activate GOUDA
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/GOUDA.git
    cd GOUDA
...
#. Install |pre-commit|_::
   ...
   ``GOUDA`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/GOUDA
.. _issue tracker: https://github.com/<USERNAME>/GOUDA/issues
.. <-- end -->
